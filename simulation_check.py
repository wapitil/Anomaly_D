...
from Trash.Padim.train import train
...
def TrainTask(zip_path, folder_name):
    """当有摄像头后，需要把 train_root改为 upload_train_root"""
    try:
        ...
        train_root = Path("Datasets/MVTecAD/leather/train")

        trained_model_path = train(train_root)
